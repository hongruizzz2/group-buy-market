...
import com.hongrui.api.IMarketTradeService;
    ...
    public Response<LockMarketPayOrderResponseDTO> lockMarketPayOrder(LockMarketPayOrderRequestDTO lockMarketPayOrderRequestDTO) {
        try {
            ...
            if (StringUtils.isBlank(userId) || StringUtils.isBlank(source) ||
                    ...
                    StringUtils.isBlank(goodsId) || activityId == null) {
            ...
            if (teamId != null) {
                ...
                if (groupBuyProcessVO != null && Objects.equals(groupBuyProcessVO.getTargetCount(), groupBuyProcessVO.getLockCount())) {
